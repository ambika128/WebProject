...
require_once "database.php";
    ...
    if (isset($_SESSION["username1"]) && isset($_SESSION["email"]) && isset($_SESSION["gtotal"])){
      ...
      $message = "<html><body>";
      $message .= "Dear $username1,<br><br>";
      $message .= "Thank you for your payment. Your transaction of amount ₹$gtotal was successful.<br><br>";
      $message .= "Best regards,<br>";
      $message .= "Shree Ram Electronics";
      $message .= "</body></html>";
        $result1 = smtp_mailer($email, $subject, $message);
    }
   ...
   <ul class="menu-area-main mt-3" style="display: flex; gap: 20px; list-style: none; margin: 0; padding: 0; justify-content: center; font-size: 16px;">
    ...
    <!-- end header -->
      ...
      <div class="bg-dark text-white text-center p-3">
           <h1 class="text-white"> COURCES</h1>
      </div>
<br><br>
<div class="container">
   ...
   <form action="index.php" method="post">
       ...
       <div style="max-width: 100%; margin: 16px auto; padding: 20px; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); border-radius: 8px;">
                 ...
                 <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="contact">
                     ...
                     <ul class="lik">
                         ...
                         <li> <a href="product1.php">Our Cources</a></li>
