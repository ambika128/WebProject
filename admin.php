...
//             $sql = "UPDATE cart SET quantity = quantity + 1 WHERE session_id = ? AND product_id = ?";
//             $stmt = $conn->prepare($sql);
//             $stmt->bind_param("si", $session_id, $product_id);
//             $stmt->execute();
//         } else {
//             // Product is not in the cart, add a new entry
//             $sql = "INSERT INTO cart (session_id, product_id, quantity) VALUES (?, ?, 1)";
//             $stmt = $conn->prepare($sql);
//             $stmt->bind_param("si", $session_id, $product_id);
//             $stmt->execute();
//         }
...
// Check if the form was submitted for deleting product
                        ...
                        <div class="limit-box">
                            <nav class="main-menu">
                                <ul class="menu-area-main">
                                    ...
                                    <li class="active"> <a href="admin.php">Product</a> </li>
                                    <li> <a href="admindelete.php">Delete Product</a> </li>
                ...
                <div class="products-container">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            // echo '<button type="submit" name="" class="cart-button">Delete</button>';
                            // echo '</form>';
                            echo '</div>';
                            echo '</div>';
                        }
